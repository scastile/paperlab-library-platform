  ...
  return (
    <div className="flyer-surface" style={{ background: bg }}>
      ...
      <div className="flyer-panel flyer-panel-left">
        ...
        {cta && <div className="flyer-cta flyer-cta-sm" style={{ background: accent }}>{cta}</div>}
        {logo && <img className="flyer-logo" src={logo} alt="logo" />}
      </div>
    </div>
  )
  ...
  return (
    <div className="flyer-surface" style={{ background: bg }}>
      ...
      <div className="flyer-panel flyer-panel-center">
        ...
        {cta && <div className="flyer-cta flyer-cta-outline" style={{ borderColor: accent, color: accent }}>{cta}</div>}
        {logo && <img className="flyer-logo" src={logo} alt="logo" />}
      </div>
    </div>
  )
