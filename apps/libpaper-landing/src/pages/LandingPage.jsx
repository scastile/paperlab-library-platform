...
const SERVICES = [
  ...
  },
  {
    ...
    description: 'AI-generated, print-ready event flyers in minutes — pick a layout and vibe, and get a poster, PDF, or social graphic.',
    href: '/flyer-studio',
    tint: 'tint-rose',
    tag: 'Live',
    tagClass: 'bg-emerald-500/10 text-emerald-500',
  },
  {
    icon: CalendarDays,
    title: 'Event Planner',
    description: 'Plan library programs end to end — auto-generated task checklists, budgets, and timelines for any event type. 1 credit per saved plan.',
    href: '/event-planner',
    tint: 'tint-amber',
    tag: 'Live',
    tagClass: 'bg-emerald-500/10 text-emerald-500',
